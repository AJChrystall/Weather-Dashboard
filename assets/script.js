...
const apiUrl = 'https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&appid={2ed76626b4e5f9735df0eba669822045}'; // URL for current weather API endpoint
